...
public class LunchBreak {
    public static void main(String[] args) {
        ...
        if (freeTime >= movieTime) {
            ...
            System.out.printf("You have enough time to watch %s and left with %.0f minutes free time.", movieName, timeLeft);
        } else {
            double needTime = Math.ceil(movieTime - freeTime);
            System.out.printf("You don't have enough time to watch %s, you need %.0f more minutes.", movieName, needTime);
        }
